...
<body>
	...
	<section class="container">
		<form action="patientIDSubmit.php" id="opd_form" method="POST">
		<!-- Page I starts -->
				...
				<h3>&nbsp;&nbsp;Biodata</h3>
					...
					<div class="col-md-12">
						<div class="col-md-4">
							...
							<input type="number" id="age" name="age" class="form-control" value="<?php echo $patient->first()['age']; ?>">
						</div>
						<div class="col-md-4">
					...
					<div class="col-md-12">
						<div class='col-md-4'>
							...
							<textarea id="address" name="address" rows="1" class="form-control"><?php echo $patient->first()['address']; ?></textarea>
						</div>
						<div class='col-md-4'>
					...
					<div class="col-md-12">
						<div class="col-md-4">
							...
							<input type="text" id="opd" name="opd" class="form-control" value="<?php echo $patient->first()['opd']; ?>">
						</div>
						<div class="col-md-4">
							<label for="bloodGroup">Blood Group</label>
							<select name="bloodGroup" id="bloodGroup" class="form-control" value="<?php echo $patient->first()['blood_group']; ?>">
						...
						<div class="col-md-4">
							...
							<select name="diagnose" id="diagnose" class="form-control" value="<?php echo $patient->first()['diagnose']; ?>">
		...
		<!-- Page II Starts -->
		<article class='historyArticle col-md-12 container-fluid'>
			<!-- History Section -->
			
			<div class="history">
				<h3>&nbsp;&nbsp;History</h3>
				<div class="col-md-12">
					<div class="form-group col-md-8" id="history_fields">
						<textarea name="history_1" id="history_1" cols="30" rows="2" class="form-control"></textarea>
					</div>
				</div>

				<div class="form-group">
					<button id="addMore" class="btn btn-info btn-sm" onclick="addFields('history', 'history_fields');">Add More</button>
		...
		<article id='treatmentArticle' class="treatmentArticle col-md-12 container-fluid">
			<!-- Treatment Section -->
			<h3>&nbsp;&nbsp;Treatment</h3>
			<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="form-group col-md-8">
						<textarea name="treatment" id="treatment" rows="15" class="form-control"></textarea>
					</div>
				</div>
			</div>
		</article>
		...
		<article id="remarkArticle" class="remarkArticle col-md-12 container-fluid">
			<!-- Remark Section -->
			<h3>&nbsp;&nbsp;Remark</h3>
			<div class="col-md-12">
