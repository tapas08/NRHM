...
if (Input::exists()){
	...
	for ($i = 1; $i <= 8; $i++){
		$insert = $db->insert('outdoor_diagnostic', array(
...
<body>
	...
	<form action="" method="POST" id="mis_report">
		...
		<h4>DIAGNOSTIC CATEGORISATION (OUTDOOR)</h4><br>
	...
	<input type="submit" name="submit" id="submit" class="btn btn-primary" value="SAVE &amp; Continue" form="mis_report">
	</section>
