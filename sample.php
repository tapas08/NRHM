...
<body>
	...
	<section class="container col-xs-12" id="Form1Section">
		<?php
			if(count($error) > 0){
		...
		<div class="col-xs-12">
			...
			(Report to the sent by the PHC/PHU/GAD medical officer to DMHP officer-monthly</small>
				...
				<div class="col-xs-8 details">
					<div class="col-xs-12">
						<div class="col-xs-6">Name of the Doctor :- </div>
						<div class="col-xs-6"><input type="text" id="Form1_doctor" name="Form1_doctor" class="form-control"></div>
					</div>
					<div class="col-xs-12">
						<div class="col-xs-6">Reports for the Month of  :- </div>
						<div class="col-xs-6"><input type="month" id="Form1_month" name="Form1_month" class="form-control"></div>
					</div>
					<div class="col-xs-12">
						<div class="col-xs-6">Number of Sub centers in the PHC/PHU/GAD :- </div>
						<div class="col-xs-6"><input type="number" id="Form1_centers" name="Form1_centers" class="form-control"></div>
					</div>
				</div>
			</div>
			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						<td>
							<input type="text" id="diag1_name" name="diag1_name" class="form-control" value="Organic Mental" readonly>
						</td>
						<td>
			...
			<div class='col-xs-12'>
				<div class="col-xs-6">
					<span class="col-xs-4"><label for="form1_date">Date</label></span>
					<span class="col-xs-4"><input type="date" id="form1_date" name="form1_date" class="form-control"></span>
					<span class="col-xs-4"></span>
				</div>
				<div class="col-xs-6">
					<div class="col-xs-3"></div>
					<div class="col-xs-6" id="signature">Signature of Doctor</div>
					<div class="col-xs-3"></div>
				</div>
			</div>
		</div>
